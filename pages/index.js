  ...
  return (
    <div className="relative bg-gray-white w-full flex flex-col items-start justify-start text-center text-33xl text-gray-white font-body-regular-400">
      ...
      <div className="self-stretch flex flex-col pt-16 px-0 pb-2 items-center justify-start gap-[95px] text-left text-base text-gray-black font-body-regular-600 lg:pl-[120px] lg:pr-[120px] lg:box-border md:pl-[60px] md:pr-[60px] md:box-border sm:pl-5 sm:pr-5 sm:box-border">
        ...
        <div className="flex flex-row items-end justify-center gap-[8px] text-center text-goldenrod">
          <div className="rounded bg-lemonchiffon flex flex-row p-2.5 items-start justify-start">
            <img className="relative w-6 h-6" alt="" src="/arrowleft.svg" />
          </div>
          <div className="rounded-10xs bg-goldenrod flex flex-col py-2.5 px-[9px] items-start justify-start text-gray-white">
            <div className="relative leading-[24px] font-semibold flex items-end justify-center w-[26px]">
              1
            </div>
          </div>
          <div className="rounded-10xs bg-lemonchiffon flex flex-col py-2.5 px-[9px] items-start justify-start">
            <div className="relative leading-[24px] font-semibold flex items-end justify-center w-[26px]">
              2
            </div>
          </div>
          ...
          <div className="rounded bg-goldenrod flex flex-row p-2.5 items-start justify-start">
      ...
      <Footer
        ...
        imageDimensionsText2="/social-media-logo2.svg"
        imageDimensionsCodeText="/social-media-logo3.svg"
        imageDimensionsTextCode="/social-media-logo4.svg"
      />
    </div>
  );
};
